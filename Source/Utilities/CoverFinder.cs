...
namespace Typhon
{
    internal static class CoverFinder
    {
        ...
        public static bool TryFindCastPosition(CastPositionRequest newReq, float optimal_range, out IntVec3 dest)
        {
            req = newReq;
            ...
            optimalRangeSquared = optimal_range * 0.8f * (optimal_range * 0.8f);
